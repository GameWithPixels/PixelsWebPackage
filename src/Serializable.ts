...
import { assert, decodeUtf8 } from "./utils";
...
function internalDeserialize<T extends object>(
  ...
  forEachSerializableProp(obj, (prop, value) => {
    if (typeof value === "string") {
      ...
      switch (prop.size) {
        case 1:
          setProp(obj, prop, dataView.getUint8(byteOffset), value);
          break;
        case 2:
          setProp(obj, prop, dataView.getUint16(byteOffset, true), value);
          break;
        case 4:
          setProp(obj, prop, dataView.getUint32(byteOffset, true), value);
          break;
        case 8:
          setProp(obj, prop, dataView.getBigUint64(byteOffset, true), value);
          break;
        default:
          throw new SerializationError(
            `Invalid property size, got ${prop.size} but expects 1, 2, 4, or 8`
